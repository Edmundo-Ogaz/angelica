...
requirejs.config({
    ...
    paths: {
        ...
        'fileinput': "vendor/fileinput/krajee/fileinput",
        ...
        'agendaController': "controller/proveedor/agendaController",
        'fichaDialogController': "controller/proveedor/fichaDialogController",
        'clienteController': "controller/proveedor/clienteController",
    ...
    shim: {
    	...
    	'loginController': ['jquery', 'service', 'jqGrid'],
    	'agendaController': ["jquery", "spin", "spin-jquery", "service"],
    }
});